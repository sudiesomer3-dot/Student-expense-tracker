...
export default function Budget() {
  ...
  // Text displayed between the arrows
  ...
  const monthlyExpenses = expenses.filter(expense => {
    ...
    // Works when the date is stored as YYYY-MM-DD
    if (typeof expense.date === 'string') {
      return expense.date.startsWith(monthKey)
    }

    // Works if the date is stored as a Firebase Timestamp
      ...
      <div className="max-w-4xl mx-auto p-8">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-500 min-w-36 text-center">
              {currentMonth}
            </span>
        ...
        <div className="border rounded-xl p-6 mb-6">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Overall: ${totalSpent.toFixed(2)} of ${totalBudget.toFixed(2)} spent
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white rounded-xl p-8 w-80">
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-blue-500 text-white rounded p-2 font-semibold hover:bg-blue-600"
                >
                  Save
                </button>
